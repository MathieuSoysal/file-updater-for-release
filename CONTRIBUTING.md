# Contributing to File Updater

Help wanted! We'd love your contributions to File Updater. Please review the following guidelines before contributing. Also, feel free to propose changes to these guidelines by updating this file and submitting a pull request.
...
If you've identified a bug in `file-updater-for-release`, please [submit an issue](#issue) to our GitHub repo: [javadoc-publisher](https://github.com/MathieuSoysal/file-updater-for-release/issues/new). Please also feel free to submit a [Pull Request](#pr) with a fix for the bug!
...
New issues can be created with in our [GitHub repo](https://github.com/MathieuSoysal/file-updater-for-release/issues/new).
